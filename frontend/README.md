...
**Live Demo:** [https://gridflex.lovable.app/](https://gridflex.lovable.app/)  
**Backend API:** [https://gridflex-backend-152882144214.europe-west2.run.app](https://gridflex-backend-152882144214.europe-west2.run.app)
...
**Initial Load:**
1. Fetch complete dashboard state from `/demo/generate`
2. Parse and map response to UI components
3. Display loading skeletons during fetch

**Real-time Updates:**
1. Poll backend every 5 seconds
2. Update dashboard with new values
3. Animate number changes (count-up effect)
4. Update "Last Updated" timestamp

**Demo Mode:**
1. User clicks "Run Demo" button
2. Triggers POST to `/demo/generate`
3. Dashboard updates with new optimization scenario
4. Shows visual indicators of agent activity
...
**Solutions:**
- Verify backend is running: Visit [https://gridflex-backend-152882144214.europe-west2.run.app/health](https://gridflex-backend-152882144214.europe-west2.run.app/health)
...
- Live URL: [https://gridflex.lovable.app/](https://gridflex.lovable.app/)
...
[![Backend API](https://img.shields.io/badge/API-Documentation-blue)](https://gridflex-backend-152882144214.europe-west2.run.app/docs)
